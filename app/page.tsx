  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-blue-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-base text-gray-600 leading-relaxed max-w-lg">
                An information technology student with a passion for learning
                and developing skills in software development, networking, and
                cybersecurity. Eager to contribute to real-world projects and
                gain hands-on experience in the IT industry.
              </p>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div
            className={`text-center mb-12 transition-all duration-1000 ${animatedSections.has("certifications") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Certifications and Trainings
            </h2>
            <p className="text-base text-gray-600 mx-auto">
              A collection of all the certifications, seminars, and training
              programs I have completed.
            </p>
          </div>
          <div
            className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 transition-all duration-1000 ${animatedSections.has("certifications") ? "opacity-100" : "opacity-0"}`}
          >
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white border border-blue-200 rounded-xl overflow-hidden hover:border-blue-400 hover:shadow-lg transition transform hover:scale-105 group shadow-lg">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4 text-sm">
                  Professional certification in database management and
                  administration.
                </p>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-white border border-purple-200 rounded-xl overflow-hidden hover:border-purple-400 hover:shadow-lg transition transform hover:scale-105 group shadow-lg">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4 text-sm">
                  The Ultimate Tech Event in the North - Technology conference
                  and networking.
                </p>
                <div className="flex gap-2 flex-wrap mb-4">
            ...
            <div className="bg-gradient-to-br from-red-50 to-white border border-red-200 rounded-xl overflow-hidden hover:border-red-400 hover:shadow-lg transition transform hover:scale-105 group shadow-lg">
              <div className="h-32 overflow-hidden relative">
                <img
                  src="/images/cybersummit2023.png"
                  alt="SPUP CyberSummit 2023"
                  className="w-full h-full object-cover"
                />
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4 text-sm">
                  Cybersecurity summit focused on digital security and
            ...
            <div className="bg-gradient-to-br from-green-50 to-white border border-green-200 rounded-xl overflow-hidden hover:border-green-400 hover:shadow-lg transition transform hover:scale-105 group shadow-lg">
              <div className="h-32 overflow-hidden relative">
                <img
                  src="/images/ite2025.png"
                  alt="SPUP CyberSummit 2024"
                  className="w-full h-full object-cover"
                />
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4 text-sm">
                  Advanced cybersecurity training and threat analysis workshop.
                </p>
                <div className="flex gap-2 flex-wrap mb-4">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-white border border-orange-200 rounded-xl overflow-hidden hover:border-orange-400 hover:shadow-lg transition transform hover:scale-105 group shadow-lg">
              <div className="h-32 overflow-hidden relative">
                <img
                  src="/images/capstoneshowcase.png"
                  alt="SPUP CyberSummit 2025"
                  className="w-full h-full object-cover"
                />
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4 text-sm">
                  Latest cybersecurity trends and emerging threat landscape
                  analysis.
                </p>
                <div className="flex gap-2 flex-wrap mb-4">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-white border border-teal-200 rounded-xl overflow-hidden hover:border-teal-400 hover:shadow-lg transition transform hover:scale-105 group shadow-lg">
              <div className="h-32 overflow-hidden relative">
                <img
                  ...
                  alt="SPUP CyberSecurity RoadShow 2025"
                  className="w-full h-full object-cover"
                />
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4 text-sm">
                  Interactive cybersecurity awareness and hands-on security
                  demonstrations.
                </p>
                <div className="flex gap-2 flex-wrap mb-4">
      ...
      <section id="experiences" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div
            className={`text-center mb-12 transition-all duration-1000 ${animatedSections.has("experiences") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Experiences
            </h2>
            <p className="text-base text-gray-600 mx-auto">
              A collection of roles, projects, and leadership work that
              highlight my technical abilities and the soft skills that support
              them—ranging from hands-on development to collaboration,
              problem-solving, and project execution.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div
              className={`bg-white/80 backdrop-blur border border-blue-200 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-1000 ${animatedSections.has("experiences") ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"}`}
            >
              ...
              <div className="space-y-4">
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  <h4 className="text-gray-900 font-semibold mb-1">
                    IT Department Leader and Developer
                  </h4>
                  <p className="text-gray-600 text-sm">
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    2023 SPUP–PATHWAY Hackathon
                  </p>
                </div>
              </div>
            </div>
            <div
              className={`bg-white/80 backdrop-blur border border-indigo-200 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-1000 delay-200 ${animatedSections.has("experiences") ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}`}
            >
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-indigo-500 pl-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Paulinian Student Government (2022–2023)
                  </p>
                </div>
                <div className="border-l-4 border-indigo-500 pl-4">
                  <h4 className="text-gray-900 font-semibold mb-1">
                  ...
                  <p className="text-gray-600 text-sm">
                    Paulinian Student Government (2023–2024)
                  </p>
                </div>
                <div className="border-l-4 border-indigo-500 pl-4">
                  <h4 className="text-gray-900 font-semibold mb-1">
                ...
                <div className="border-l-4 border-indigo-500 pl-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Junior Philippine Computer Society (2023–2024)
                  </p>
                </div>
                <div className="border-l-4 border-indigo-500 pl-4">
                  <h4 className="text-gray-900 font-semibold mb-1">Member</h4>
                  <p className="text-gray-600 text-sm">
                    Multimedia Committee, Rotaract Club of Tuguegarao
                    (2023–2024)
                  </p>
                </div>
              </div>
